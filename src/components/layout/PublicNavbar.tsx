  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        ...
        <button onClick={goHome} className="group cursor-pointer inline-flex items-center gap-2">
          ...
          {LINKS.map((l) => {
            ...
            return (
              <button
                ...
                className={[
                  "relative px-4 py-2 rounded-full text-sm font-medium cursor-pointer transition-all duration-300 outline-none",
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2 cursor-pointer text-sm rounded-lg border border-white/10 text-[--fg-muted] hover:text-[--primary] hover:border-[--primary] transition"
          >
            Log in
          </button>
          <button
            onClick={() => navigate("/signup")}
            className="px-4 py-2 cursor-pointer text-sm rounded-xl text-white bg-[--primary] hover:bg-[--primary-hover] transition"
          >
            Get started
          </button>
        </div>
